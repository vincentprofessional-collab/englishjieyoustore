  ...
  },
  {
    content: {
      ...
      items: [
        ...
        {
          actionLabel: "",
          description: "一分钟准备、两分钟个人陈述，首版整理 227 道。",
          enabled: true,
          eyebrow: "Long turn",
        ...
        {
          actionLabel: "",
          description: "围绕抽象问题展开观点讨论，首版整理 49 道。",
          enabled: true,
          eyebrow: "Discussion",
      ...
      secondaryHref: "",
      secondaryLabel: "",
      summary: "按 Part 1、Part 2、Part 3 整理历年真题、高分思路、BBC 词汇与口语范文。",
      theme: "editorial",
