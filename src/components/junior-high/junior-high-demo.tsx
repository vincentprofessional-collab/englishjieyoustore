...
import { getJuniorHighPaper } from "@/lib/junior-high/paper-catalog";
import {
  JUNIOR_HIGH_REGIONS,
  JUNIOR_HIGH_SAMPLES,
  JUNIOR_HIGH_YEARS,
...
export function JuniorHighDemo() {
  ...
  const catalogPaper = mode === "mock" ? getJuniorHighPaper(year, region) : undefined;
  if (catalogPaper) return <JuniorHighPaperWorkbench onBack={() => setMode("mock-select")} paper={catalogPaper} />;
